...
class StorePerfilRequest extends FormRequest
{
    ...
    {
        $this->merge([
            'empleadoId' => $this->input('empleadoId', $this->input('empleado_id')),
        ]);
    }
    ...
    {
        return [
            'empleadoId'      => ['required', 'string', 'max:255', 'unique:perfiles,empleado_id'],
    ...
    {
        return [
            'empleadoId.required' => 'El ID del empleado es obligatorio.',
            'empleadoId.unique'   => 'Ya existe un perfil para ese empleado.',
